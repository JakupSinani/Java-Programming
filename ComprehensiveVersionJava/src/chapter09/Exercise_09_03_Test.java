...
public class Exercise_09_03_Test {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < values.length; i++) {
            System.out.println(values[i] + " " + Exercise_09_03.isEven(values[i]));
        }

        System.out.println("\nTest if values are odd using isOdd(int):");
        for (int i = 0; i < values.length; i++) {
            System.out.println(values[i] + " " + Exercise_09_03.isOdd(values[i]));
        }

        System.out.println("\nTest if values are prime using isPrime(int):");
        for (int i = 0; i < values.length; i++) {
            System.out.println(values[i] + " " + Exercise_09_03.isPrime(values[i]));
        }
        ...
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            Exercise_09_03 value = new Exercise_09_03(values[i]);
        ...
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            Exercise_09_03 value = new Exercise_09_03(values[i]);
            System.out.println(value.getValue() + " " + Exercise_09_03.isEven(value));
        }
        ...
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            Exercise_09_03 value = new Exercise_09_03(values[i]);
            System.out.println(value.getValue() + " " + Exercise_09_03.isOdd(value));
        }
        ...
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            Exercise_09_03 value = new Exercise_09_03(values[i]);
            System.out.println(value.getValue() + " " + Exercise_09_03.isPrime(value));
        }

        // Test equals(int) and equals(MyInteger)
        int[] values2 = {5, 9, 7};
        Exercise_09_03 value = new Exercise_09_03(9);
        ...
        System.out.println("\nTest if " + value.getValue() +
                " is equal to the specified value:");
        for (int i = 0; i < values2.length; i++) {
            Exercise_09_03 myInteger = new Exercise_09_03(values2[i]);
        ...
        System.out.println("\' + \"" + numericString + "\" = " +
                (Exercise_09_03.parseInt(numericCharacters) +
                        Exercise_09_03.parseInt(numericString)));
    }
}

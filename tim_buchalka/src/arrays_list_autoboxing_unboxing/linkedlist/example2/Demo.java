package arrays_list_autoboxing_unboxing.linkedlist.example2;
...
public class Demo {
    public static void main(String[] args) {
        ...
        addInOrder(placeToVisit, "Brisban");
    ...
    private static boolean addInOrder(LinkedList<String> linkedList, String newCity) {
        ...
        while (stringListIterator.hasNext()) {
            ...
            if (comparison == 0) {
                ...
                return false; // false meaning that it wasn't successfully added.

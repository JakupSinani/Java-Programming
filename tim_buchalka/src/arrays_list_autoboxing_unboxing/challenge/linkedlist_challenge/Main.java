package arrays_list_autoboxing_unboxing.challenge.linkedlist_challenge;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Soldire of fortune", 3.13);
        albums.add(album);

        album = new Album("For those about to rock", "AC/DC");
        album.addSong("For those abouut to rock", 5.44);
